...
-   the [Apache Parquet](https://parquet.apache.org/) format for minimal filesize and fast access

-   the [HDF5](https://www.hdfgroup.org/solutions/hdf5/) format with faster access but slightly larger filesize
