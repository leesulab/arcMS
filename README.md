...
tutorial](data-filtration-tutorial.html) on how to query, filter,
aggregate data (e.g. to obtain chromatograms or spectra) in the
`article("data-filtration-tutorial")`.
